 ...
 * @description: 机构基金数据分发
 * @author: zhangyanfeng
 * @create: 2024-04-21 19:34
 **/
@Service
public class FundDispatcherCommand extends DispatcherCommand implements InitializingBean {
    @Override
    protected List<DistributionContent> fetchDistributionContent(DispatcherInfo dispatcherInfo) {
        List<DistributionContent> distributions = dispatcherInfo.getDispatcherInfo().get(DistributionAnalyzeType.FUND);
        //机构类型的基金可直接进行分发
    ...
    protected void distributeContent(List<DistributionContent> contents, TargetUserCriteria targetUser, DistributionStrategy distributionStrategy, DispatchTiming dispatchTiming) {
        System.out.println("基金分发处理...........");
    }

    @Override
    public void afterPropertiesSet() throws Exception {
        DistributeExecutor.register(DistributionAnalyzeType.FUND, this);
    }
}
