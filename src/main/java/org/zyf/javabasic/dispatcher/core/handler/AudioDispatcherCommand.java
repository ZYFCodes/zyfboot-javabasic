 ...
 * @description: 音频内容分发
 * @author: zhangyanfeng
 * @create: 2024-04-21 20:15
 **/
@Service
public class AudioDispatcherCommand extends DispatcherCommand implements InitializingBean {
    @Override
    protected List<DistributionContent> fetchDistributionContent(DispatcherInfo dispatcherInfo) {
        List<DistributionContent> distributions = dispatcherInfo.getDispatcherInfo().get(DistributionAnalyzeType.AUDIO);
        //机构类型的基金可直接进行分发
    ...
    protected void distributeContent(List<DistributionContent> contents, TargetUserCriteria targetUser, DistributionStrategy distributionStrategy, DispatchTiming dispatchTiming) {
        System.out.println("音频分发处理...........");
    }

    @Override
    public void afterPropertiesSet() throws Exception {
        DistributeExecutor.register(DistributionAnalyzeType.AUDIO, this);
    }
}
