...
public class CSDNSubmitManyOthersTest {
    ...
    public static void main(String[] args) {
        ...
        Set<Integer> articleIds = CSDNArticles.getRandomArticleIdsForOthers(30);
